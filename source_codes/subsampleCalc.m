function k_entropy = subsampleCalc(k)
    %SUBSAMPLECALC Summary of this function goes here
...
%             for i=1:num
    ...
    save(strcat("Subsample_Results/", num2str(k), "_results.csv"), scores);


    k_entropy = avg_min_entropy;
