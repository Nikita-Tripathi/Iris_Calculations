...
t = [];
for i=1:num
     t = [t readmatrix(strcat("/Users/nikitatripathi/Desktop/domain-specific-BSIF-for-iris-recognition/source_codes/All_Intra_Results/", a(i).name ))];
%      histogram(t, 'Normalization', 'probability');
end
