...
for c=classes
    ...
    for i=1:num
        ...
        masks(:,:,i) = imread(strcat('/Users/nikitatripathi/Desktop/NDI-IRIS-DATA-NOTRE-DAME/Output/NormalizedMasks/', c, '/', num2str(i), '_mano.bmp'));
    end
...
%     allscores = [allscores; scores];
    writematrix(scores, strcat("All_Intra_results_2/", c, "_results.csv"));
%     cls = cls+1;
end
